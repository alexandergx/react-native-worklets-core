...
function makeWorklet(t, fun, state) {
  ...
  if (sourceMapString) {
    initDataObjectExpression.properties.push(t.objectProperty(t.identifier("__sourceMap"), t.stringLiteral(sourceMapString)));
  }
